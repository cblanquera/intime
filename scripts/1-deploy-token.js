...
async function main() {
  ...
  console.log('Deploying InTime ...')
  const token = await deploy('InTime', admin.address)

  console.log('')
  console.log('-----------------------------------')
  console.log('InTime deployed to:', token.address)
  console.log(
  ...
  console.log('-----------------------------------')
  console.log('Roles:')
  console.log(' - InTime: MINTER_ROLE')
  console.log('')
  console.log('Next Steps:')
  console.log('In InTime contract, grant MINTER_ROLE to admin')
