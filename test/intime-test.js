...
const ERC777Vanila = artifacts.require('ERC777Vanila');

contract('ERC777Vanila', function (accounts) {
  ...
  beforeEach(async function () {
    this.token = await ERC777Vanila.new(name, symbol, defaultOperators, initialSupply, owner);
  });
